...
> **🎯 Separador Visual:** Neste documento, o Desenvolvedor deve utilizar o pipe, separador visual de textos quando houver colunas e as linhas abaixo dos títulos devem ficar alinhadas com os títulos, facilitando a leitura.
...
├── DEPENDE DE: public/fluxo_app/images/ (logo.png + mascote + veículos)
...
Este documento fornece uma visão geral abrangente do módulo `fluxo_app` do Projeto GFauto. Ele engloba os componentes, estilos e lógicas que governam a experiência do usuário visitante, desde a interação inicial na página principal até a captura de dados para busca de serviços..
...
- **Interface de Busca Principal:** Apresentação do formulário de busca de serviços na página inicial
- **Captura de Dados do Usuário:** Coleta de informações como Estado, Cidade e "O que Procura?"(Especialidades) para localização
- **Autocompletar Inteligente:** Sistema de sugestões para Estados, Cidades brasileiras do Estado e Especialidades da Cidade
- **Detecção Automática:** Identificação de Cidade baseado no Estado selecionado e de Especialidades baseadas na Cidade Selecionada.
...
Em GFauto/mapa_pastas_GFauto.md e GFauto/README_geral.md
...
O `fluxo_app` é composto pelas seguintes subpastas e arquivos principais e pertence ao `GFauto/mapa_pastas_GFauto.md`:
...
|---|---|---|---|
| `HeroSectionCorreto.tsx` 											| Componente principal da seção hero (422 linhas) 	| ~50 KB 				| 29/06/2025 |
| `HeroSectionCorreto1.tsx.bak` 								| Backup do componente principal 								| ~45 KB 				| 29/06/2025 |
| `HeroSectionCorreto1_comEstados_eCidades...` 	| Versão com funcionalidades de localização 			| ~55 KB 				| 29/06/2025 |
...
1. **Seção Principal de Busca:**
   - Formulário com campos de estado, cidade e "O que Procura?"
...
- [ ] Verifiquei que estou num ambiente 100% atualizado com o GitHub: Gfauto = https://github.com/RLuizWeber/GFauto.git
...
|---|---|---|---|
| **Next.js Image Component** 	| -40% tpo carregamento imagens 	| `next/image` para mc4.png | Lighthouse |
...
| **Manual Testing** 		| Verificação visual 				| Semanal 				| Weber |
...
- **Lição "É fácil andar só para a frente":** Comportamento correto para progresso constante baseado em fatos
...
|---|---|---|---|
| **3.0.0** 	| 26/06/2025 	| Guia de Referência Rápida + CSS customizado como principal 	| Weber |
| **2.2.0** 	| 25/06/2025 	| Correção com informações reais, Footer global 							| Weber |
| **2.1.0** 	| 25/06/2025 	| Correção de CSS e implementação Tailwind 								| Weber |
| **2.0.0** 	| 24/06/2025 	| Refatoração completa do componente 										| Weber |
...
|---|---|---|---|
| **Desenvolvedor Principal** 	| Weber 					| GitHub: @RLuizWeber 	| 24/7 |
| **Arquiteto de Software** 		| Desenvolvedor 		| Desenvolvedor 				| 27/7 |
